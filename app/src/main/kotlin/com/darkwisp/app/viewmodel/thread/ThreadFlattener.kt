package com.darkwisp.app.viewmodel.thread

import com.darkwisp.app.nostr.NostrEvent

/**
 * Pure, side-effect-free flattener that turns a parent→children reply tree into a
 * [ThreadItem] list for the UI. Shared by [com.darkwisp.app.viewmodel.ThreadViewModel] and
 * [com.darkwisp.app.viewmodel.ArticleViewModel] so the two paths can't drift.
 *
